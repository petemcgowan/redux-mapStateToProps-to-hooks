...
A simple currency exchange calculator built to demonstrate using redux with react hooks/functional.

This also uses new school Redux useSelector and useDispatch.
